<div class="footer">
    <div class="wrapper">
        ...
        <div class="footer-hyperlinks">
            ...
            <a href="<?php echo $this->linkedin; ?>" target="_blank"><i class="fab fa-linkedin"></i></a> 
            <a href="<?php echo $this->twitter; ?>" target="_blank"><i class="fab fa-twitter-square"></i></a>
			<a href="mailto:<?php echo $this->contact; ?>" class="hyperlink"><i class="fas fa-envelope" style="width: 21px !important; height: 24px;"></i></a>
        </div>
    </div>
</div>
