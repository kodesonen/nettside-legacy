...
(function(window) {
  ...
  var cookieChoices = (function() {
    ...
    function _createHeaderElement(cookieTitle, cookieText, dismissText, linkText, linkHref) {
      var butterBarStyles = 'background-color:#eee;' +
          'margin:0;z-index:1000;text-align:center;';

      var cookieConsentElement = document.createElement('div');
      cookieConsentElement.id = cookieConsentId;
      cookieConsentElement.style.cssText = butterBarStyles;
	  cookieConsentElement.appendChild(_createConsentTitle(cookieTitle));
    ...
    function _createDialogElement(cookieTitle, cookieText, dismissText, linkText, linkHref) {
      ...
      dismissLink.style.marginTop = '24px';
	  
	  content.appendChild(_createConsentTitle(cookieTitle));
    ...
    function _removeCookieConsent() {
      ...
      if (cookieChoiceElement != null) {
		...
		document.write("<div id='cookieChoiceInfo-cover' style='display: none !important'></div>");
		location.reload();
      }
    }
	...
	if(_shouldDisplayConsent()) {
		document.write("<div id='cookieChoiceInfo-cover'></div>");
	}
